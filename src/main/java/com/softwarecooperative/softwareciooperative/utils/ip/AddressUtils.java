package com.softwarecooperative.softwareciooperative.utils.ip;
...
import com.softwarecooperative.softwareciooperative.utils.http.HttpUtils;
...
public class AddressUtils
{
    ...
    public static String getRealAddressByIP(String ip)
    {
        ...
        if (SoftCooperativeDesignConfig.isAddressEnabled())
        {
            try
            {
