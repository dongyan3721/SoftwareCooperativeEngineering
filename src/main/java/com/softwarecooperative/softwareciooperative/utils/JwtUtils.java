...
public class JwtUtils {
     ...
     * 过期时间，1.5亿年
     */
    private static final long EXPIRE_TIME = Long.MAX_VALUE / 2 - System.currentTimeMillis() - 114514; //120 * 60 * 1000;
    ...
    public static String verify(String token) throws UnAuthenticatedException {
        try {
            ...
            throw new GeneralServiceException("Token error", HttpStatus.UNAUTHORIZED);
        }
    }
